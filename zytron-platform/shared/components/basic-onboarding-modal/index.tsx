...
import { openagentsai_CALENDLY } from '@/shared/constants/links';
          ...
          {step === 'done' && (
            <div className="flex flex-col gap-4 items-center">
              ...
              <p className="text-center">
                Book a discovery call to learn more about openagentsai and how openagentsai
                can help you automate operations!
              </p>
              <Link href={openagentsai_CALENDLY} target="_blank">
