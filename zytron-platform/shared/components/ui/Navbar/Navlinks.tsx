...
import { DISCORD, PLATFORM, openagentsai_GITHUB } from '@/shared/constants/links';
    ...
    <div className="relative flex flex-row justify-between py-4 align-center md:py-6">
      <div className="flex flex-shrink-0 items-center ">
        ...
        <nav className="flex ml-2 md:ml-6 gap-3">
          ...
          <Link href={openagentsai_GITHUB} className={cn(s.link, 'hidden md:inline')}>
            GitHub
          </Link>
          <Link href={DISCORD} className={cn(s.link, 'hidden md:inline')}>
            Community
          </Link>
          <Link href="https://openagentsai.apac.ai/en/latest/" className={s.link}>
              Docs
            </Link>
          {user && (
