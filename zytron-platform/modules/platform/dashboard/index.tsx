...
import { DISCORD, PLATFORM, openagentsai_CALENDLY } from '@/shared/constants/links';
import {
  VLM_SAMPLE_GO,
  VLM_SAMPLE_JS,
  VLM_SAMPLE_PY
      ...
      <div className="flex flex-col gap-4 mt-4">
        ...
        {!subscription.isSubscribed && (
          <div className="border rounded-md p-8 py-10">
            ...
            <span className="text-muted-foreground">
              openagentsai AI API subscription includes:
            </span>
        ...
        <div className="flex gap-4">
          ...
          <div className="w-1/2 flex flex-col gap-2 border rounded-md p-4">
            ...
            <span className="text-muted-foreground">
              Learn more about openagentsai through our documentation.
            </span>
            <Link href="https://openagentsai.apac.ai/en/latest/">
              <Button className="mt-4" variant={'default'}>
                Documention
              </Button>
            </Link>
        ...
        <div className="flex gap-4 border p-4 rounded-md mb-8">
          <div className="w-full flex flex-col gap-2">
            ...
            <span className="text-muted-foreground">
              Join the openagentsai community real-time support and asistance,
            </span>
            <div className="flex gap-4 mt-4">
              <Link href={DISCORD}>
                <Button variant={'default'}>Discord</Button>
              </Link>
              <Link href={openagentsai_CALENDLY}>
