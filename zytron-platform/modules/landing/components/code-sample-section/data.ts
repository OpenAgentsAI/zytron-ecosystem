const codeStep1 = `from openagentsai import Agent, ChromaDB, OpenAIChat
...
const codeStep2 = `from openagentsai import QwenVLMultiModal
...
from openagentsai import ToolAgent
from openagentsai.utils.json_utils import base_model_to_json
...
`;
const codeStep4 = `from openagentsai.models import HuggingfaceLLM
...
const content = [
  ...
  },
  {
    ...
    description:
      "The HuggingFaceLLM class in the OpenAgentsAI library provides a simple and easy-to-use interface to harness the power of Hugging Face's transformer-based language models, specifically for causal language modeling.",
    sampleCodes: {
      python: {
