...
class openagentsaiCloudUsageLogger:
    """openagentsai Cloud Usage Logger
    ...
    Args:
        ...
        supabase_table (str, optional): _description_. Defaults to "openagentsai_cloud_usage".
    ...
    def __init__(
        ...
        supabase_url: str,
        supabase_key: str,
        supabase_table: Optional[str] = "openagentsai_cloud_usage",
        *args,
        **kwargs,
    ):
    ...
    def log_usage(
        ...
        **kwargs,
        ...
        """Log usage of openagentsai Cloud API
        ...
        try:
            ...
            response = self.supabase.table("openagentsai_cloud_usage").insert(data).execute()
            return response
        except Exception as error:
    ...
    def check_api_key(self, api_key: str = None):
        ...
        try:
            query = (
                self.supabas.table("openagentsai_cloud_usage")
                .select("*")
                .eq("api_key", api_key)
                .execute()
            )
