...
Here are three usage examples of the `Transformer` class from the OpenAgentsAI library:

```python
from OpenAgentsAI.nn import Transformer
...
- OpenAgentsAI Library: Link to the official documentation of the OpenAgentsAI library.
